...
print("Finished.creating.all boundary.conditions...")
#
...
for k in range(1, 42+1):
    lagrangeNodes[k]= modelSpace.newNodeXY(0.00, 0.00)
...
print("Finished.creating.all beam.nodes...")
#
...
beamContactInfo = open.beamContactInfo.dat.w()

#puts $beamContactInfo "1001  100  99  88 1001  "
print(beamContactInfo."1001.100, 99, 88, 1001, "()
#puts $beamContactInfo "1002  100  99 109 1002  "
print(beamContactInfo."1002.100, 99, 109, 1002, "()
#puts $beamContactInfo "1003   99 101  92 1003  "
print(beamContactInfo."1003.99, 101, 92, 1003, "()
#puts $beamContactInfo "1004   99 101 112 1004  "
print(beamContactInfo."1004.99, 101, 112, 1004, "()
#puts $beamContactInfo "1005  101 106  93 1005  "
print(beamContactInfo."1005.101, 106, 93, 1005, "()
#puts $beamContactInfo "1006  101 106 116 1006  "
print(beamContactInfo."1006.101, 106, 116, 1006, "()
#puts $beamContactInfo "1007  106 113  98 1007  "
print(beamContactInfo."1007.106, 113, 98, 1007, "()
#puts $beamContactInfo "1008  106 113 119 1008  "
print(beamContactInfo."1008.106, 113, 119, 1008, "()
#puts $beamContactInfo "1009  113 123 105 1009  "
print(beamContactInfo."1009.113, 123, 105, 1009, "()
#puts $beamContactInfo "1010  113 123 126 1010  "
print(beamContactInfo."1010.113, 123, 126, 1010, "()
#puts $beamContactInfo "1011  123 128 115 1011  "
print(beamContactInfo."1011.123, 128, 115, 1011, "()
#puts $beamContactInfo "1012  123 128 135 1012  "
print(beamContactInfo."1012.123, 128, 135, 1012, "()
#puts $beamContactInfo "1013  128 141 125 1013  "
print(beamContactInfo."1013.128, 141, 125, 1013, "()
#puts $beamContactInfo "1014  128 141 144 1014  "
print(beamContactInfo."1014.128, 141, 144, 1014, "()
#puts $beamContactInfo "1015  141 151 139 1015  "
print(beamContactInfo."1015.141, 151, 139, 1015, "()
#puts $beamContactInfo "1016  141 151 158 1016  "
print(beamContactInfo."1016.141, 151, 158, 1016, "()
#puts $beamContactInfo "1017  151 168 150 1017  "
print(beamContactInfo."1017.151, 168, 150, 1017, "()
#puts $beamContactInfo "1018  151 168 171 1018  "
print(beamContactInfo."1018.151, 168, 171, 1018, "()
#puts $beamContactInfo "1019  168 184 166 1019  "
print(beamContactInfo."1019.168, 184, 166, 1019, "()
#puts $beamContactInfo "1020  168 184 185 1020  "
print(beamContactInfo."1020.168, 184, 185, 1020, "()
#puts $beamContactInfo "1021  184 197 182 1021  "
print(beamContactInfo."1021.184, 197, 182, 1021, "()
#puts $beamContactInfo "1022  184 197 200 1022  "
print(beamContactInfo."1022.184, 197, 200, 1022, "()
#puts $beamContactInfo "1023  197 219 199 1023  "
print(beamContactInfo."1023.197, 219, 199, 1023, "()
#puts $beamContactInfo "1025  219 242 221 1025  "
print(beamContactInfo."1025.219, 242, 221, 1025, "()
#puts $beamContactInfo "1027  242 264 244 1027  "
print(beamContactInfo."1027.242, 264, 244, 1027, "()
#puts $beamContactInfo "1029  264 285 267 1029  "
print(beamContactInfo."1029.264, 285, 267, 1029, "()
#puts $beamContactInfo "1031  285 311 291 1031  "
print(beamContactInfo."1031.285, 311, 291, 1031, "()
#puts $beamContactInfo "1033  311 338 315 1033  "
print(beamContactInfo."1033.311, 338, 315, 1033, "()
#puts $beamContactInfo "1035  338 368 344 1035  "
print(beamContactInfo."1035.338, 368, 344, 1035, "()
#puts $beamContactInfo "1037  368 396 372 1037  "
print(beamContactInfo."1037.368, 396, 372, 1037, "()
#puts $beamContactInfo "1039  396 417 400 1039  "
print(beamContactInfo."1039.396, 417, 400, 1039, "()
#puts $beamContactInfo "1041  417 435 421 1041  "
print(beamContactInfo."1041.417, 435, 421, 1041, "()
...
#set nodeListPerm {}
nodeListPerm = set nodeListPerm   
#set channel [open "NodesInfoPerm.dat" r]
channel = open."NodesInfoPerm.dat".r()
...
solidElementList = set solidElementList   
#set channel [open "SolidElementInfo.dat" r]
channel = open."SolidElementInfo.dat".r()
...
# beam element list
#set BeamElementList {}
BeamElementList = set BeamElementList   
#set channel [open "beamElementInfo.dat" r]
channel = open."beamElementInfo.dat".r()
...
#set BCElemList {}
BCElemList = set BCElemList   
#set channel [open "beamContactInfo.dat" r]
channel = open."beamContactInfo.dat".r()
...
"recorder.ModelSpace.NewNodeIDXY(-file, displacement.out(-time(-node, nodeListPerm(-dof(1, 2, disp")
...
recorder.ModelSpace.NewNodeIDXY(-file, lift1/disp.out(-time(-modelSpace.newNodeIDXY(430, 437, 446, 455, 461, 468, 473, 476, 480, 482, 484, -dof(1, 2, disp)
...
recorder.ModelSpace.NewNodeIDXY(-file, lift2/disp.out(-time(-modelSpace.newNodeIDXY(412, 424, 433, 444, 453, 460, 466, 471, 475, 479, 483, -dof(1, 2, disp)
...
recorder.ModelSpace.NewNodeIDXY(-file, lift3/disp.out(-time(-modelSpace.newNodeIDXY(387, 405, 418, 429, 442, 450, 458, 464, 470, 477, 481, -dof(1, 2, disp)
...
recorder.ModelSpace.NewNodeIDXY(-file, lift4/disp.out(-time(-modelSpace.newNodeIDXY(363, 380, 398, 414, 427, 439, 448, 457, 465, 472, 478, -dof(1, 2, disp)
...
recorder.ModelSpace.NewNodeIDXY(-file, lift5/disp.out(-time(-modelSpace.newNodeIDXY(336, 353, 378, 395, 411, 425, 440, 449, 459, 467, 474, -dof(1, 2, disp)
...
recorder.ModelSpace.NewNodeIDXY(-file, lift6/disp.out(-time(-modelSpace.newNodeIDXY(308, 326, 347, 369, 392, 408, 426, 441, 452, 462, 469, -dof(1, 2, disp)
...
recorder.ModelSpace.NewNodeIDXY(-file, lift7/disp.out(-time(-modelSpace.newNodeIDXY(281, 304, 322, 345, 370, 394, 415, 428, 443, 454, 463, -dof(1, 2, disp)
...
recorder.ModelSpace.NewNodeIDXY(-file, lift8/disp.out(-time(-modelSpace.newNodeIDXY(260, 278, 302, 325, 346, 374, 399, 419, 434, 447, 456, -dof(1, 2, disp)
...
recorder.ModelSpace.NewNodeIDXY(-file, lift9/disp.out(-time(-modelSpace.newNodeIDXY(241, 253, 277, 306, 327, 350, 379, 406, 422, 438, 451, -dof(1, 2, disp)
...
recorder.ModelSpace.NewNodeIDXY(-file, lift10/disp.out(-time(-modelSpace.newNodeIDXY(218, 239, 259, 282, 307, 335, 364, 389, 413, 431, 445, -dof(1, 2, disp)
...
#remove node 1042
remove.modelSpace.newNodeIDXY(1042)
# soil nodes
#remove node 430
remove.modelSpace.newNodeIDXY(430)
#remove node 437
remove.modelSpace.newNodeIDXY(437)
#remove node 446
remove.modelSpace.newNodeIDXY(446)
#remove node 455
remove.modelSpace.newNodeIDXY(455)
#remove node 461
remove.modelSpace.newNodeIDXY(461)
#remove node 468
remove.modelSpace.newNodeIDXY(468)
#remove node 473
remove.modelSpace.newNodeIDXY(473)
#remove node 476
remove.modelSpace.newNodeIDXY(476)
#remove node 480
remove.modelSpace.newNodeIDXY(480)
#remove node 482
remove.modelSpace.newNodeIDXY(482)
#remove node 484
remove.modelSpace.newNodeIDXY(484)
#
...
# lagrange multiplier node
#remove node 1040
remove.modelSpace.newNodeIDXY(1040)
# soil nodes
#remove node 412
remove.modelSpace.newNodeIDXY(412)
#remove node 424
remove.modelSpace.newNodeIDXY(424)
#remove node 433
remove.modelSpace.newNodeIDXY(433)
#remove node 444
remove.modelSpace.newNodeIDXY(444)
#remove node 453
remove.modelSpace.newNodeIDXY(453)
#remove node 460
remove.modelSpace.newNodeIDXY(460)
#remove node 466
remove.modelSpace.newNodeIDXY(466)
#remove node 471
remove.modelSpace.newNodeIDXY(471)
#remove node 475
remove.modelSpace.newNodeIDXY(475)
#remove node 479
remove.modelSpace.newNodeIDXY(479)
#remove node 483
remove.modelSpace.newNodeIDXY(483)
#
...
# lagrange multiplier node
#remove node 1038
remove.modelSpace.newNodeIDXY(1038)
# soil nodes
#remove node 387
remove.modelSpace.newNodeIDXY(387)
#remove node 405
remove.modelSpace.newNodeIDXY(405)
#remove node 418
remove.modelSpace.newNodeIDXY(418)
#remove node 429
remove.modelSpace.newNodeIDXY(429)
#remove node 442
remove.modelSpace.newNodeIDXY(442)
#remove node 450
remove.modelSpace.newNodeIDXY(450)
#remove node 458
remove.modelSpace.newNodeIDXY(458)
#remove node 464
remove.modelSpace.newNodeIDXY(464)
#remove node 470
remove.modelSpace.newNodeIDXY(470)
#remove node 477
remove.modelSpace.newNodeIDXY(477)
#remove node 481
remove.modelSpace.newNodeIDXY(481)
#
...
# lagrange multiplier node
#remove node 1036
remove.modelSpace.newNodeIDXY(1036)
# soil nodes
#remove node 363
remove.modelSpace.newNodeIDXY(363)
#remove node 380
remove.modelSpace.newNodeIDXY(380)
#remove node 398
remove.modelSpace.newNodeIDXY(398)
#remove node 414
remove.modelSpace.newNodeIDXY(414)
#remove node 427
remove.modelSpace.newNodeIDXY(427)
#remove node 439
remove.modelSpace.newNodeIDXY(439)
#remove node 448
remove.modelSpace.newNodeIDXY(448)
#remove node 457
remove.modelSpace.newNodeIDXY(457)
#remove node 465
remove.modelSpace.newNodeIDXY(465)
#remove node 472
remove.modelSpace.newNodeIDXY(472)
#remove node 478
remove.modelSpace.newNodeIDXY(478)
#
...
# lagrange multiplier node
#remove node 1034
remove.modelSpace.newNodeIDXY(1034)
# soil nodes
#remove node 336
remove.modelSpace.newNodeIDXY(336)
#remove node 353
remove.modelSpace.newNodeIDXY(353)
#remove node 378
remove.modelSpace.newNodeIDXY(378)
#remove node 395
remove.modelSpace.newNodeIDXY(395)
#remove node 411
remove.modelSpace.newNodeIDXY(411)
#remove node 425
remove.modelSpace.newNodeIDXY(425)
#remove node 440
remove.modelSpace.newNodeIDXY(440)
#remove node 449
remove.modelSpace.newNodeIDXY(449)
#remove node 459
remove.modelSpace.newNodeIDXY(459)
#remove node 467
remove.modelSpace.newNodeIDXY(467)
#remove node 474
remove.modelSpace.newNodeIDXY(474)
#
...
# lagrange multiplier node
#remove node 1032
remove.modelSpace.newNodeIDXY(1032)
# soil nodes
#remove node 308
remove.modelSpace.newNodeIDXY(308)
#remove node 326
remove.modelSpace.newNodeIDXY(326)
#remove node 347
remove.modelSpace.newNodeIDXY(347)
#remove node 369
remove.modelSpace.newNodeIDXY(369)
#remove node 392
remove.modelSpace.newNodeIDXY(392)
#remove node 408
remove.modelSpace.newNodeIDXY(408)
#remove node 426
remove.modelSpace.newNodeIDXY(426)
#remove node 441
remove.modelSpace.newNodeIDXY(441)
#remove node 452
remove.modelSpace.newNodeIDXY(452)
#remove node 462
remove.modelSpace.newNodeIDXY(462)
#remove node 469
remove.modelSpace.newNodeIDXY(469)
#
...
# lagrange multiplier node
#remove node 1030
remove.modelSpace.newNodeIDXY(1030)
# soil nodes
#remove node 281
remove.modelSpace.newNodeIDXY(281)
#remove node 304
remove.modelSpace.newNodeIDXY(304)
#remove node 322
remove.modelSpace.newNodeIDXY(322)
#remove node 345
remove.modelSpace.newNodeIDXY(345)
#remove node 370
remove.modelSpace.newNodeIDXY(370)
#remove node 394
remove.modelSpace.newNodeIDXY(394)
#remove node 415
remove.modelSpace.newNodeIDXY(415)
#remove node 428
remove.modelSpace.newNodeIDXY(428)
#remove node 443
remove.modelSpace.newNodeIDXY(443)
#remove node 454
remove.modelSpace.newNodeIDXY(454)
#remove node 463
remove.modelSpace.newNodeIDXY(463)
#
...
# lagrange multiplier node
#remove node 1028
remove.modelSpace.newNodeIDXY(1028)
# soil nodes
#remove node 260
remove.modelSpace.newNodeIDXY(260)
#remove node 278
remove.modelSpace.newNodeIDXY(278)
#remove node 302
remove.modelSpace.newNodeIDXY(302)
#remove node 325
remove.modelSpace.newNodeIDXY(325)
#remove node 346
remove.modelSpace.newNodeIDXY(346)
#remove node 374
remove.modelSpace.newNodeIDXY(374)
#remove node 399
remove.modelSpace.newNodeIDXY(399)
#remove node 419
remove.modelSpace.newNodeIDXY(419)
#remove node 434
remove.modelSpace.newNodeIDXY(434)
#remove node 447
remove.modelSpace.newNodeIDXY(447)
#remove node 456
remove.modelSpace.newNodeIDXY(456)
#
...
# lagrange multiplier node
#remove node 1026
remove.modelSpace.newNodeIDXY(1026)
# soil nodes
#remove node 241
remove.modelSpace.newNodeIDXY(241)
#remove node 253
remove.modelSpace.newNodeIDXY(253)
#remove node 277
remove.modelSpace.newNodeIDXY(277)
#remove node 306
remove.modelSpace.newNodeIDXY(306)
#remove node 327
remove.modelSpace.newNodeIDXY(327)
#remove node 350
remove.modelSpace.newNodeIDXY(350)
#remove node 379
remove.modelSpace.newNodeIDXY(379)
#remove node 406
remove.modelSpace.newNodeIDXY(406)
#remove node 422
remove.modelSpace.newNodeIDXY(422)
#remove node 438
remove.modelSpace.newNodeIDXY(438)
#remove node 451
remove.modelSpace.newNodeIDXY(451)
#
...
# lagrange multiplier node
#remove node 1024
remove.modelSpace.newNodeIDXY(1024)
# soil nodes
#remove node 218
remove.modelSpace.newNodeIDXY(218)
#remove node 239
remove.modelSpace.newNodeIDXY(239)
#remove node 259
remove.modelSpace.newNodeIDXY(259)
#remove node 282
remove.modelSpace.newNodeIDXY(282)
#remove node 307
remove.modelSpace.newNodeIDXY(307)
#remove node 335
remove.modelSpace.newNodeIDXY(335)
#remove node 364
remove.modelSpace.newNodeIDXY(364)
#remove node 389
remove.modelSpace.newNodeIDXY(389)
#remove node 413
remove.modelSpace.newNodeIDXY(413)
#remove node 431
remove.modelSpace.newNodeIDXY(431)
#remove node 445
remove.modelSpace.newNodeIDXY(445)
#
