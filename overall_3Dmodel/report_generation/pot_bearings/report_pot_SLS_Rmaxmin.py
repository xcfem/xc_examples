...
texFileName=texDir+'pot_bearing_ELS_Rmaxmin.tex'
texF=open(texFileName,'w') #
prf.gen_Rmaxmin_table(texF,dictRmaxmin,caption='Apoyos POT. Valores de carga máximos y mínimos en combinaciones de ELS')
texF.close()
