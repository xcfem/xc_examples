...
for ky in LCGs2display:
    ...
    model.out.displayDispRot(itemToDisp='uX',setToDisplay=None,fileName= grphPath+grFileName,captionText=caption)
    ...
    model.out.displayDispRot(itemToDisp='uY',setToDisplay=None,fileName= grphPath+grFileName,captionText=caption)
    oh.insertGrInTex(texFile=textfl,grFileNm=grphRltvPath+grFileName,grWdt=env.cfg.grWidth,capText=caption,labl=fLabel)
    fLabel=lcName+'uZ'
    grFileName=fLabel+'.png'
    caption=lcDescr+'. Desplazamiento vertical Z (mm)'
    model.out.displayDispRot(itemToDisp='uZ',setToDisplay=None,fileName= grphPath+grFileName,captionText=caption)
    oh.insertGrInTex(texFile=textfl,grFileNm=grphRltvPath+grFileName,grWdt=env.cfg.grWidth,capText=caption,labl=fLabel)
