...
sect2Disp=[RCsect.piloteT1ARCSects,RCsect.piloteT1BRCSects,RCsect.piloteT2RCSects,RCsect.piloteT3RCSects,RCsect.piloteT4RCSects]
#sect2Disp=[RCsect.fbeamRCSectsZ1,RCsect.fbeamRCSectsZ4a,RCsect.fbeamRCSectsZ4b,RCsect.fbeamRCSectsZ2,RCsect.fbeamRCSectsZ3,RCsect.fbeamRCSectsZ6,RCsect.fbeamRCSectsZ5]
...
for sect in sect2Disp:
  ...
  sect1inf=section_report.SectionInfoHASimple(preprocessor,sect1,sectGrWth=sectGrWth)
  ...
  if writeSection2:
      #Section 2
      # plotting of section geometric and mechanical properties
      sect2inf=section_report.SectionInfoHASimple(preprocessor,sect2,sectGrWth=sectGrWth)
