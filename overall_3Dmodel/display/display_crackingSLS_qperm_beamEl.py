...
for st in sets2DispRes:
    for arg in arguments:
        model.out.displayBeamResult(attributeName=lsd.quasiPermanentLoadsCrackControl.label, itemToDisp=arg, beamSetDispRes=st, setToDisplay=setDisp, caption=None, fileName=None, defFScale=0.0,defaultDirection='J')
