...
for st in sets2Disp:
    for arg in arguments:
        out.displayFieldDirs1and2(limitStateLabel=lsd.shearResistance.label,argument=arg,setToDisplay= st,component=None,fileName=None, defFScale=0.0,rgMinMax=rgMinMax)
