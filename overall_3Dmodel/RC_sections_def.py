...
deckRCSects= element_section_map.LegacyRCSlabBeamSection(name='deckRCSects',sectionDescr='slab of shell elements',concrType=datM.concrete, reinfSteelType=datM.reinfSteel,depth=dat.deckTh,elemSet=model.decks)  
...
footRCSects= element_section_map.LegacyRCSlabBeamSection(name='footRCSects',sectionDescr='footation',concrType=datM.concrete, reinfSteelType=datM.reinfSteel,depth=dat.footTh,elemSet=model.foot)
...
wallRCSects= element_section_map.LegacyRCSlabBeamSection(name='wallRCSects',sectionDescr='wall of shell elements',concrType=datM.concrete, reinfSteelType=datM.reinfSteel,depth=dat.wallTh,elemSet=model.wall)  
...
beamXRCsect=element_section_map.LegacyRCSlabBeamSection(name='beamXRCsect',sectionDescr='beam elements in X direction',concrType=datM.concrete, reinfSteelType=datM.reinfSteel,width=dat.wbeamX,depth=dat.hbeamX,elemSet=model.beamX)
...
beamYRCsect=element_section_map.LegacyRCSlabBeamSection(name='beamYRCsect',sectionDescr='beam elements in Y direction',concrType=datM.concrete, reinfSteelType=datM.reinfSteel,width=dat.wbeamY,depth=dat.hbeamY,elemSet=model.beamY)
...
columnZRCsect=element_section_map.LegacyRCSlabBeamSection(name='columnZRCsect',sectionDescr='columnZ',concrType=datM.concrete, reinfSteelType=datM.reinfSteel,width=dat.wcolumnZ,depth=dat.hcolumnZ,elemSet=model.columnZ)
