...
exec(default_config.compileCode(cfg.projectDirTree.getVerifCrackQpermFile()))
...
oh.displayFieldDirs1and2(limitStateLabel=lsd.quasiPermanentLoadsCrackControl.label, argument=argument, setToDisplay=setDisp, component=None, fileName=None, defFScale=0.0, rgMinMax=rgMinMax)
