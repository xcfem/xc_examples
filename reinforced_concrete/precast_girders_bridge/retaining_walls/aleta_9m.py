...
#Geometry
zTopWall= 9.7 # z coordinate of the wall top.
...
bToe= 3.0 # width of the toe.
bHeel= 4.75-stemBottomWidth # width of the heel.
footingThickness= 1.35 # thickness of the footing.
...
wall.stemReinforcement.setReinforcement(2,A25_20.getCopy('A')) # vert. trasdós (contacto terreno)
...
wall.footingReinforcement.setReinforcement(3,A25_20.getCopy('A')) #tr. sup. zapata
