...
exec(open(xc_model.cfg.projectDirTree.getVerifShearFile()).read())
...
xc_model.oh.displayBeamResult(attributeName=lsd.shearResistance.label, itemToDisp= argument, beamSetDispRes= setDisp,setToDisplay=setDisp, fileName=None, defFScale=0.0)
