...
exec(default_config.compileCode(xc_model.cfg.projectDirTree.getVerifCrackQpermFile()))



#  Config
argument= 'getCF' #Possible arguments: 'CF', 'N', 'My','Mz'
...
xc_model.oh.displayBeamResult(attributeName=lsd.quasiPermanentLoadsCrackControl.label, itemToDisp= argument, beamSetDispRes= setDisp,setToDisplay=setDisp, fileName=None, defFScale=0.0)
