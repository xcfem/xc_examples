...
exec(default_config.compileCode(xc_model.cfg.projectDirTree.getVerifCrackFreqFile()))
...
xc_model.oh.displayBeamResult(attributeName=lsd.freqLoadsCrackControl.label, itemToDisp= argument, beamSetDispRes= setDisp,setToDisplay=setDisp, fileName=None, defFScale=0.0)
