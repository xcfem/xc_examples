...
testOK= ((abs(ratio01)<1e-10) and (abs(ratio02)<1e-10) and (abs(ratio03)<1e-10) and (abs(ratio04)<1e-10))
...
testOK= testOK and ((abs(ratio11)<1e-10) and (abs(ratio12)<1e-10) and (abs(ratio13)<1e-10))
...
testOK= testOK and ((abs(ratio21)<1e-10) and (abs(ratio22)<1e-10) and (abs(ratio23)<1e-10))
...
ratio31= abs(R3a[0]+R3b[0]+R3c[0]+F)/F
ratio32= abs(R3a[1]+R3b[1]+R3c[1])/F
ratio33= abs(R3a[2]+R3b[2]+R3c[2])/F
R3= R3a+R3b+R3c

testOK= testOK and ((abs(ratio31)<1e-10) and (abs(ratio32)<1e-10) and (abs(ratio33)<1e-10))
