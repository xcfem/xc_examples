...
for st in sets2DispRes:
    for arg in arguments:
        out.displayBeamResult(attributeName=lsd.freqLoadsCrackControl.label, itemToDisp=arg, beamSetDispRes=st, setToDisplay=setDisp, caption=None, fileName=None, defFScale=0.0,defaultDirection='J')
